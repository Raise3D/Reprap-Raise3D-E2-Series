...
extern "C" void hsmciIdle(uint32_t stBits, uint32_t dmaBits)
{
	...
	if (reprap.GetSpinningModule() != moduleFilamentSensors && reprap.GetFilamentSensorSwitch())
	{
...
bool RepRap::GetFilamentSensorSwitch()
{
	return isFilamentSensorOn;
}

void RepRap::SetFilamentSensorSwitch(bool isOn)
{
	isFilamentSensorOn = isOn;
}
void RepRap::Init()
{
