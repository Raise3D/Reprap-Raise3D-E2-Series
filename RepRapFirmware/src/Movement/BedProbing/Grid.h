...
public:
	...
	void EstimatePlane(float &a, float &b, float &c, float &d) const;//Raise fitting plane with grid points
	float GetFlatness() const; // Raise get planeness for the bed plane
